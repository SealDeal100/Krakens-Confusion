...
public class AlternateWorldPortalTriggerProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock() == Blocks.MOSS_BLOCK && (world.getBlockState(BlockPos.containing(x, y + 3, z))).getBlock() == Blocks.MOSS_BLOCK) {
